...
const (
	CreateOrderService_CreateOrderPayment_FullMethodName = "/order.CreateOrderService/CreateOrderPayment"
)
...
type CreateOrderServiceClient interface {
	CreateOrderPayment(ctx context.Context, in *CreateOrderRequest, opts ...grpc.CallOption) (*CreateOrderResponse, error)
}
...
func (c *createOrderServiceClient) CreateOrderPayment(ctx context.Context, in *CreateOrderRequest, opts ...grpc.CallOption) (*CreateOrderResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateOrderResponse)
	err := c.cc.Invoke(ctx, CreateOrderService_CreateOrderPayment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CreateOrderServiceServer interface {
	CreateOrderPayment(context.Context, *CreateOrderRequest) (*CreateOrderResponse, error)
...
func (UnimplementedCreateOrderServiceServer) CreateOrderPayment(context.Context, *CreateOrderRequest) (*CreateOrderResponse, error) {
...
func _CreateOrderService_CreateOrderPayment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateOrderRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CreateOrderServiceServer).CreateOrderPayment(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CreateOrderService_CreateOrderPayment_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CreateOrderServiceServer).CreateOrderPayment(ctx, req.(*CreateOrderRequest))
	}
...
var CreateOrderService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "order.CreateOrderService",
	HandlerType: (*CreateOrderServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CreateOrderPayment",
			Handler:    _CreateOrderService_CreateOrderPayment_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "grpc/proto/createOrder.proto",
}
